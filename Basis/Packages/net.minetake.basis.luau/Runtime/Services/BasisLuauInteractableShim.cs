...
namespace Minetake.Basis.Luau.Services
{
	...
	public class BasisLuauInteractableShim : BasisInteractableObject // Need to remove at a later point.
	{
		...
		public override void OnHoverStart(BasisInput input)
		{
		    ...
		    {
		        BasisDebug.LogWarning($"{nameof(BasisLuauInteractableShim)}: Failed to setup input on hover");
		        return;
		    }
