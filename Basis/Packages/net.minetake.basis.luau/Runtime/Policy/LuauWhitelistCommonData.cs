...
using BasisPickupInteractable = global::Basis.Scripts.BasisSdk.Interactions.BasisPickupInteractable;
using BasisInteractableObject = global::Basis.Scripts.BasisSdk.Interactions.BasisInteractableObject;
using BasisInput = global::Basis.Scripts.Device_Management.Devices.BasisInput;
using BasisNetworkPlayer = global::Basis.Scripts.Networking.NetworkedAvatar.BasisNetworkPlayer;
using UnityEngine;
using UnityEngine.Events;

namespace Minetake.Basis.Luau.Policy
{
    internal static partial class LuauWhitelistCommonData
    {
        internal static readonly HashSet<string> CommonWhiteListType = new HashSet<string>()
        {
			...
			"Minetake.Basis.Luau.Services.BasisNetworkShim",
			"Minetake.Basis.Luau.Services.BasisNetworkShim*",
			"Minetake.Basis.Luau.Services.BasisLuauOsc*",
			"Basis.Network.Core.DeliveryMethod",
			"Minetake.Basis.Luau.Services.BasisLuauSafeUtil",
			"Basis.Scripts.BasisSdk.Players.BasisLocalPlayer",
			"Basis.Scripts.Networking.NetworkedAvatar.BasisNetworkPlayer",
			"HVR.Basis.Comms.OSC*",

			// Cilbox types
			"Minetake.Basis.Luau.Policy.LuauPublicUtils",
        ...
        internal static readonly HashSet<string> CommonWhiteListFields = new HashSet<string>()
        {
        ...
        internal static readonly Dictionary<Type, HashSet<string>> CommonMethodWhitelist = new Dictionary<Type, HashSet<string>>()
        {
			...
			{ typeof(BasisPickupInteractable), new HashSet<string> { } },
			{ typeof(BasisInteractableObject), new HashSet<string> { } },
			{ typeof(BasisInput), new HashSet<string> { } },
